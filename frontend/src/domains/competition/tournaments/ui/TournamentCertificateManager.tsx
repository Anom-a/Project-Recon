...
export default function TournamentCertificateManager({ tournamentId, tournament, standings, userRole }: TournamentCertificateManagerProps) {
  ...
  const isStaff = userRole === 'Admin' || userRole === 'Manager' || userRole === 'Secretary' || userRole === 'EventManager';
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-4 flex items-center justify-between text-[10px] text-slate-400">
                <span>Status: {previewTeam.awards[previewAward.key] === 'issued' ? '✓ Issued' : previewTeam.awards[previewAward.key] === 'pending' ? '○ Pending' : '○ Not assigned'}</span>

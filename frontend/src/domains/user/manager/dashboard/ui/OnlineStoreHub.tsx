      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1 max-w-[200px]">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search..."
            className="w-full pl-6 pr-2 py-1 bg-white border border-slate-200 rounded-lg text-[11px] text-slate-700 placeholder:text-slate-400 focus:outline-none focus:border-brand-red/30"
          />
        </div>
        {categories.map(c => (

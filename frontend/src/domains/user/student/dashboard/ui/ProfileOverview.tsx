...
export default function ProfileOverview({ currentUser }: Props) {
  return (
    <div className="flex flex-col gap-6">
      {/* Header Card */}
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-[#e1e2ed]/60 flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="flex flex-col flex-1 text-center md:text-left w-full">
          ...
          <p className="font-sans text-[#737686] text-sm mt-1">Student ID: #ST-2023-8942</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-[#e1e2ed]/60 flex items-center gap-4 hover:shadow-md transition-shadow">
          <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center shrink-0">
            <BookOpen className="w-6 h-6 text-[#2563EB]" />
          </div>
          <div>
            <p className="text-xs font-mono font-bold text-[#737686] uppercase">Active Tracks</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-[#e1e2ed]/60 flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div className="w-full">
            <div className="flex justify-between items-end mb-1">
              <p className="text-xs font-mono font-bold text-[#737686] uppercase">Overall Progress</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-[#e1e2ed]/60 flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            <p className="text-xs font-mono font-bold text-[#737686] uppercase">Completed Projects</p>

...
export default function UpcomingEvents() {
  return (
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-[#e1e2ed]/60">
      ...
      <div className="relative border-l-2 border-[#e1e2ed] ml-3 pl-6 flex flex-col gap-6">
        <div className="relative">
          <div className="absolute -left-[31px] top-1.5 w-3.5 h-3.5 rounded-full bg-[#2563EB] border-[3px] border-white shadow-sm" />
          <div className="bg-[#faf8ff] p-4 rounded-xl border border-[#e1e2ed]/50 flex flex-col gap-1.5 hover:shadow-md transition-shadow">
            <h4 className="font-sans font-bold text-slate-900 text-sm">VEX Regional Finals Prep</h4>
            <p className="text-xs text-[#737686] font-medium">(Sat 15th)</p>
        ...
        <div className="relative">
          ...
          <div className="bg-[#faf8ff] p-4 rounded-xl border border-[#e1e2ed]/50 flex flex-col gap-1.5 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-[#737686] font-medium">(Wed 19th)</p>
            <button className="self-start mt-2 text-xs font-semibold bg-[#2563EB] text-white px-5 py-2 rounded-full hover:bg-[#004ac6] transition-colors shadow-sm">Join</button>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="bg-[#faf8ff] p-4 rounded-xl border border-[#e1e2ed]/50 flex flex-col gap-1.5 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-[#737686] font-medium">(Fri 21st)</p>
            <button className="self-start mt-2 text-xs font-semibold bg-[#2563EB] text-white px-5 py-2 rounded-full hover:bg-[#004ac6] transition-colors shadow-sm">Join</button>
          </div>
        </div>
      </div>

    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <div className="relative flex-1 max-w-xs">
          ...
          <input value={searchQuery} onChange={e => setSearchQuery(e.target.value)} placeholder="Search periods..." className="w-full pl-8 pr-3 py-1.5 bg-white border border-brand-border rounded-lg text-xs focus:outline-none focus:border-brand-red" />
        </div>
